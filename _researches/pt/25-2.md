...
<a href="http://aberto.univem.edu.br/bitstream/handle/11077/316/ViMeT+%13+Projeto+E+Implementa%E7%E3o+de+um+Framework+Para+Aplica%E7%F5es+De+Treinamento+M%E9dico+Usando+Realidade+Virtual.pdf?sequence=1" class="btn btn-outline-primary">Monografia</a>
<a href="{{ 'files/researches/DiagramadeClasses.pdf' | absolute_url }}" class="btn btn-outline-primary">Diagrma de classes</a>
<a href="{{ 'files/researches/Cookbook.pdf' | absolute_url }}" class="btn btn-outline-primary">Cookbook</a>
