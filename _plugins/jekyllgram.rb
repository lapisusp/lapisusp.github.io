...
module Jekyll
  ...
  class Jekyllgram < Liquid::Block
    ...
    def initialize(tag, params, token)
      @limit = params.to_i
      @access_token = 'IGQVJYM2V0dnRKdHRKZAFdFRGhVT3NFcFJPWEtVOEVMWjFaVTVleGh3YmNSTVFsenVKME05Tkc4UXBRZAXhDY2p5QU1EWVdLNjA2N2x4VkE2MzVyOTQ3dHhDMkNDZA0lLVXB2SEU3aDFiRkdYTW9URzROSgZDZD'
